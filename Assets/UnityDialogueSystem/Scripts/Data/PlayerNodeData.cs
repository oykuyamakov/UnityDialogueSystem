...
namespace UnityDialogueSystem.Scripts.Data
{
    ...
    public class PlayerNodeData : NodeData
    {
        ...
        public PlayerNodeData(string guid, Vector2 graphPosition, List<PlayerLine> playerLines)
        ...
        [JsonConstructor]
        public PlayerNodeData(string guid, float graphX, float graphY, List<PlayerLine> playerLines)
